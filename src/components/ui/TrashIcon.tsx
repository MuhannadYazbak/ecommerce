export default function TrashIcon(){
    return (
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" height='1em' width='1em'
	 viewBox="0 0 32 32" enable-background="new 0 0 32 32" aria-label="remove item" role="img">
