export default function CreateNewItemIcon(){
    return (
<svg version="1.1" id="Uploaded to svgrepo.com" xmlns="http://www.w3.org/2000/svg" 
	 width="1em" height="1em" viewBox="0 0 32 32">
<g>
	<path d="M26.516,21l3-3H30v0.93L27.93,21H26.516z M21,15.93l3-3V12h-0.484L21,14.516V15.93z M24,23.516l-3,3V27
	...
	<path d="M30,17h-5v-5c0-0.552-0.448-1-1-1h-1V2c0-0.552-0.448-1-1-1H8C7.696,1,7.409,1.138,7.219,1.375l-4,5
