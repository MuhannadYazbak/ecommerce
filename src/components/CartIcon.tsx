...
export default function CartIcon() {
  ...
  // 2. Fetch the active locale parameter from the dynamic path
  ...
  return (
    // 3. Prefix the href with the dynamic locale variable
    <Link href={`/${locale}/cart`} className="relative w-full block">
