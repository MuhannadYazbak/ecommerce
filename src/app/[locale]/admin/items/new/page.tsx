...
export async function generateMetadata() {
  ...
  return {
    title: t.metadata.newItemTitle,
    description: t.metadata.newItemDescription,
    keywords: [
    ...
    openGraph : {
      title: t.metadata.newItemTitle,
      description: t.metadata.newItemDescription,
      url: "https://techmart.com/admin/items/new",
      siteName: 'TechMart'
    },
    alternates: {
      canonical: "https://techmart.com/admin/items/new"
    }
