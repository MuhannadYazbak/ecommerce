...
export class ItemPage extends BasePage {
    ...
    constructor(page: Page, item: Item) {
        ...
        this.item = item;
        this.itemHeading = this.page.locator(`[data-testid='itemHeading']`)
        this.itemName = this.page.locator('#item-name')
        this.itemPhoto = this.page.locator(`[data-testid='photo']`)
        //this.itemPhoto = this.page.locator(`img[alt="Photo of ${this.item.name}"]`)
        this.itemDescription = this.page.locator(`[data-testid='description']`)
        this.itemPrice = this.page.locator(`[data-testid='price']`)
        ...
        this.itemQuantity = this.page.locator(`[datatestid='quantity']`)
